...
public:
    ...
    friend MATHLIBRARY_API vectors operator+(vectors& v1, vectors& v2);
    friend MATHLIBRARY_API vectors operator-(vectors& v1, vectors& v2);
    friend MATHLIBRARY_API vectors operator*(int num, vectors& v1);
    friend MATHLIBRARY_API std::ostream& operator<<(std::ostream& os, vectors& v1);
};