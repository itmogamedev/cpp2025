...
//
namespace POSITIONS {
constexpr sf::Vector2u scoreTopRight =
    sf::Vector2u(120, 10);  // actually -120 but it's U-vector
constexpr sf::Vector2f scoreCenter = sf::Vector2f(0.f, -30.f);

constexpr sf::Vector2f playAgainCenter =
    sf::Vector2f(scoreCenter.x * 2.5, scoreCenter.y * 2.5);
}  // namespace POSITIONS
//
}  // namespace Constants::TEXT
