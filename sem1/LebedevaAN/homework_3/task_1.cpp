...
public:
	Healing(const std::wstring& name, int price, double weight, int health_points) : MagicItem(name, price, weight), health_points_(health_points) {};
...
public:
	Joke(const std::wstring& name, int price, double weight, const std::wstring& anecdote) : MagicItem(name, price, weight), anecdote_(anecdote) {};
	std::variant<int, double, std::wstring> getSpecialParam() const {
		return anecdote_;
	}
...
public:
	Defense(const std::wstring& name, int price, double weight, double damage_reduction) : MagicItem(name, price, weight), damage_reduction_(damage_reduction) {};
	std::variant<int, double, std::wstring> getSpecialParam() const {
...
public:
	Dice(const std::wstring& name, int price, double weight, int dice_luck) : MagicItem(name, price, weight), dice_luck_(dice_luck) {};
