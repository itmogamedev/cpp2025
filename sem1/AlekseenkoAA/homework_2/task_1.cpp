// task_1.cpp : преобразование из десятичной в шестнадцатеричную и восьмеричную систему счисления
#include <iostream>
#include <format>
#include <string>
#include <limits>

std::string dec2Hex(int a) {
    return std::format("{:0x}", a);
}

std::string dec2Oct(int a) {
    return std::format("{:o}", a);
}
