...
void createSampleData() {
  ...
  dataFile << "Зелье Эликсир_Знаний 800 0.3 90.0\n";
...
int main() {
  std::cout << "___ОТЧЕТ ГИЛЬДИИ ТОРГОВЦЕВ МАГИЧЕСКИМИ АРТЕФАКТАМИ___"
            << std::endl;
  std::cout << "Анализ товаров на торговых постах" << std::endl << std::endl;
